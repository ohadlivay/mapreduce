...
/* Driver class */
public class DailyAppLaunchDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("Daily App Launch Analysis");
    ...
    public static void main(String args[]) throws Exception {
        ...
        int res = ToolRunner.run(new Configuration(), new DailyAppLaunchDriver(), args);
        System.exit(res);
    }
}